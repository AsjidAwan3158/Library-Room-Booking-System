...
//pages
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "LibraryBookingSystem.html"));
});

app.get("/admin", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "LibraryBookingAdmin.html"));
});
...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:5500",
      "http://127.0.0.1:5500",
      "file:///D:/projects/libraryBookingSystem/Frontend/LibraryBookingSystem.html",
    ],
    credentials: true,
  })
);
